...
from app.models.waiter import Tab, TabStatus
...
def list_tabs(
    ...
    # query params "status" e "tableId" -> /tabs?status=aberta&tableId=... (histórico da mesa)
    tabs = crud_table.list_tabs(db, _tenant_id(db), status_filter, table_id)
